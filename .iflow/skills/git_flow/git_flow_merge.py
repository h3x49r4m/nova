...
class GitFlowMerge:
    ...
    def merge_branch(self, branch_name: str, target_branch: Optional[str] = None) -> Tuple[int, str]:
        """
    ...
    def _has_circular_dependency(self, branch_name: str, visited: Optional[Set[str]] = None) -> bool:
        """
