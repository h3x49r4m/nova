...
class MergeResult:
    ...
    strategy_used: ConflictResolutionStrategy | None = None
...
class ConflictResolver:
    ...
    def _load_conflicts(self) -> None:
        ...
        if self.conflict_log_file.exists():
            try:
                with open(self.conflict_log_file) as f:
    ...
    def _save_conflicts(self) -> None:
        ...
        try:
            ...
            raise IFlowError(
                f"Failed to save conflict log: {e!s}",
    ...
    def resolve_conflict(
        ...
        custom_merge_fn: Callable[[Any, Any, Any], Any] | None = None
    ) -> MergeResult:
        """
    ...
    def _merge_dicts(
        ...
        for key in all_keys:
            ...
            # Key only in remote
            elif (key not in base and key not in local) or local_val == base_val:
                merged[key] = remote_val
            elif remote_val == base_val or local_val == remote_val:
                merged[key] = local_val
