...
class ProfileManager:
    ...
    def delete_profile(self, name: str):
        ...
        if profile_file.exists():
            try:
                ...
                raise IFlowError(
                    f"Failed to delete profile file: {e!s}",
    ...
    def _get_inheritance_chain(self, profile_name: str, visited: set[str] | None = None) -> list[str]:
        """
    ...
    def export_profile(
        ...
        try:
            ...
            raise IFlowError(
                f"Failed to export profile: {e!s}",
                ErrorCode.FILE_WRITE_ERROR
            )
    ...
    def import_profile(
        ...
        try:
            ...
            raise IFlowError(
                f"Failed to import profile: {e!s}",
    ...
    def generate_env_file(
        ...
        if output_file:
            try:
                ...
                raise IFlowError(
                    f"Failed to write .env file: {e!s}",
                    ErrorCode.FILE_WRITE_ERROR
                )
