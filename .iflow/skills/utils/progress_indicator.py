...
class ProgressIndicator:
    ...
    def _display(self, message: str | None = None):
    ...
    def _calculate_eta(self, elapsed: float) -> float | None:
...
class MultiProgressIndicator:
    ...
    def update(self, key: str, increment: int = 1, message: str | None = None):
