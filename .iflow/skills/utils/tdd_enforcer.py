...
class TDDEnforcer:
    ...
    def _is_test_file(self, file_path: str) -> bool:
        ...
        return bool(filename.startswith("test_") or filename.endswith("_test.py"))
    ...
    def _get_corresponding_test_file(self, impl_file: str) -> str | None:
    ...
    def _log_violations(self, violations: list[dict[str, Any]]):
        ...
        try:
            ...
            if self.tdd_violation_log.exists():
                with open(self.tdd_violation_log) as f:
