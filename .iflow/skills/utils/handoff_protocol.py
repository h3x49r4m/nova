...
class HandoffRequirement:
    ...
    def mark_satisfied(self, evidence: str | None = None):
...
class Handoff:
    ...
    def __init__(
        ...
        self.initiated_at: str | None = None
...
class HandoffProtocol:
    ...
    def _save_protocols(self):
        ...
        try:
            ...
            raise IFlowError(
                f"Failed to save protocols: {e!s}",
                ErrorCode.FILE_WRITE_ERROR
            )

    def _deserialize_handoff(self, data: dict[str, Any]) -> Handoff | None:
        ...
        try:
            ...
            self.logger.warning(f"Failed to deserialize handoff: {e!s}")
            return None
