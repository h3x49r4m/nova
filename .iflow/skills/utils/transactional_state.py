...
class TransactionalStateManager:
    ...
    def __init__(self, state_dir: Path):
        ...
        self.current_transaction: StateTransaction | None = None
    ...
    def _load_transaction_log(self) -> None:
        ...
        if self.transaction_log_file.exists():
            try:
                with open(self.transaction_log_file) as f:
    ...
    def _save_transaction_log(self) -> None:
        ...
        try:
            ...
            raise IFlowError(
                f"Failed to save transaction log: {e!s}",
    ...
    def transaction(
        ...
        try:
            ...
            raise IFlowError(
                f"Transaction failed and was rolled back: {e!s}",
    ...
    def read_state(self, file_path: Path) -> Any | None:
        """
        Read a state file.
    ...
    def get_current_transaction(self) -> StateTransaction | None:
        """
