...
class RateLimiter:
    ...
    def get_block_time_remaining(self, identifier: str) -> int | None:
        """
...
class TokenManager:
    ...
    def __init__(self, secret_key: str | None = None, token_expiry_hours: int = 24):
        """
    ...
    def generate_token(self, user_id: str, username: str, roles: list[str]) -> str:
        ...
        if JWT_AVAILABLE:
            ...
            expires_at = datetime.now(UTC) + self.token_expiry
    ...
    def generate_refresh_token(self, user_id: str, username: str) -> str:
        ...
        if JWT_AVAILABLE:
            ...
            # Use simple token system
            token = secrets.token_urlsafe(32)
            expires_at = datetime.now(UTC) + self.refresh_token_expiry
...
class Authenticator:
    ...
    def _save_credentials(self) -> None:
        ...
        try:
            ...
            raise IFlowError(
                f"Failed to save credentials: {e!s}",
...
class AuthenticationSystem:
    ...
    def login(
        ...
        """
        # Check rate limit
        is_allowed, _remaining_attempts = self.rate_limiter.check_rate_limit(username)
    ...
    def check_permission(
        ...
        from .rbac import ResourceType as RBACResourceType
