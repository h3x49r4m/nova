...
def validate_workflow_state(data: dict, schema_dir: Path | None = None) -> tuple[bool, list[str]]:
    """
...
def validate_branch_state(data: dict, schema_dir: Path | None = None) -> tuple[bool, list[str]]:
    """
...
def validate_pipeline_state(data: dict, schema_dir: Path | None = None) -> tuple[bool, list[str]]:
    """
