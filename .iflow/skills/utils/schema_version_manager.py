...
class SchemaVersionManager:
    ...
    def _save_migrations(self):
        ...
        try:
            ...
            raise IFlowError(
                f"Failed to save migrations: {e!s}",
                ErrorCode.FILE_WRITE_ERROR
            )
    ...
    def get_version(self, version: str) -> SchemaVersion | None:
        """
        ...
        for migration in path:
            ...
            if migration_key in self.migration_functions:
                try:
                    ...
                    return False, f"Migration failed: {e!s}", data
            else:
