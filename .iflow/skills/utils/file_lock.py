...
class FileLock:
    ...
    def __init__(self, lock_file: str | Path, timeout: float = 30.0):
        """
...
@contextmanager
def locked_file(file_path: str | Path, mode: str = 'r', timeout: float = 30.0) -> Any:
    """
    ...
    with FileLock(lock_file, timeout=timeout), open(file_path, mode) as f:
        yield f


def read_locked_json(file_path: str | Path, timeout: float = 30.0) -> dict[str, Any]:
    """
