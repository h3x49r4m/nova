...
from utils.skill_invoker import (
...
class TestPipelineOrchestration(unittest.TestCase):
    ...
    def test_concurrent_workflow_operations(self):
        ...
        try:
            ...
            with FileLock(str(workflow_file)):
                # Simulate some work
...
class TestPipelineOrchestrator(unittest.TestCase):
    ...
    def test_pipeline_start_success(self):
        ...
        # Start pipeline
        code, _output = orchestrator.start()
    ...
    def test_pipeline_cancel(self):
        ...
        code, _output = orchestrator.cancel()
        self.assertEqual(code, 1)
    ...
    def test_pipeline_state_persistence(self):
        ...
        code, _output = new_orchestrator.load_state(state_file)
        self.assertEqual(code, 0)
    ...
    def test_skill_invocation_with_context(self):
        ...
        # Start pipeline
        _code, _output = orchestrator.start()
