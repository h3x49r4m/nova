...
class TestWorkflowExecutor(unittest.TestCase):
    ...
    def test_execute_simple_workflow(self):
        ...
        code, _output = self.executor.execute_workflow(workflow)
    ...
    def test_dry_run_mode(self):
        ...
        code, _output = executor.execute_workflow(workflow)
    ...
    def test_cancel_workflow(self):
        ...
        code, _output = self.executor.cancel_workflow(workflow)
